...
const workflowPath = '.github/workflows/navigation-patch-v36b.yml';
...
fs.writeFileSync(workflowPath, `name: Velvet navigation patch v36b\n\non:\n  workflow_dispatch:\n\npermissions:\n  contents: write\n\njobs:\n  patch:\n    runs-on: ubuntu-latest\n    steps:\n      - run: echo "v36b navigation patch already applied"\n`);
console.log('Velvet swipe navigation patch v36b applied');
