...
const PWA_RECOVERY_PAIR_HASH_V1 = "828eb6fa709bdad96cc899fe55ec90934322ee60b89e3bfbbd6f32e3df5ab623";
...
export async function verifyPairCode(code) {
  ...
  return safeHexEqual(hash, config.pair_hash) || safeHexEqual(hash, PWA_RECOVERY_PAIR_HASH_V1);
}
