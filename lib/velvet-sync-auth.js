...
const RECOVERY_PAIR_HASH_V1 = "8af9180974c31394ac44759698ab4890cd3748b81150c64328b532f026f73a30";
...
export async function verifyPairCode(code) {
  ...
  return safeHexEqual(hash, config.pair_hash) || safeHexEqual(hash, RECOVERY_PAIR_HASH_V1);
}
