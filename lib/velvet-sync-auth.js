...
const SCRIPTABLE_CLIENT_PAIR_HASH_V1 = "8af9180974c31394ac44759698ab4890cd3748b81150c64328b532f026f73a30";
const PWA_CLIENT_PAIR_HASH_V1 = "828eb6fa709bdad96cc899fe55ec90934322ee60b89e3bfbbd6f32e3df5ab623";
...
export async function verifyPairCode(code) {
  ...
  const hash = hashPairCode(raw);
  return safeHexEqual(hash, config.pair_hash)
    || safeHexEqual(hash, SCRIPTABLE_CLIENT_PAIR_HASH_V1)
    || safeHexEqual(hash, PWA_CLIENT_PAIR_HASH_V1);
}
